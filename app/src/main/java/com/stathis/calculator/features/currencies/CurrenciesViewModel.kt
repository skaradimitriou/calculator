...
import com.stathis.calculator.model.RatesModel
...
class CurrenciesViewModel : ViewModel() {
    ...
    private lateinit var model : NewResponseModel
...
//        })
    ...
    fun validateInput(currencyFrom: String, currencyTo: String) {
        when(currencyFrom.isNullOrEmpty() || currencyTo.isNullOrEmpty()){
            true -> wrongInput.value = true
            false -> performCalculations(currencyFrom,currencyTo)
        }
    }

    private fun performCalculations(currencyFrom : String, currencyTo : String) {
        //FIXME: Write Logic for the converter according to each currency rate
        Log.d("",currencyFrom)
        Log.d("",currencyTo)
